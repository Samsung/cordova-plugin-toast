...
* Guide [wiki](https://github.com/Samsung/cordova-plugin-toast/wiki).
* Youtube [Youtube link](https://youtu.be/vv5emwgtrDc) for 2016 SDC tech session : Write Once and Run Everywhere with TOAST for Smart TV.
* TOAST introduce video [TOAST video](https://www.samsungdforum.com/toastAD) contains introduce for TOAST briefly. It would help you understand easily.
