...
MediaIns.prototype.registerHook = function (hook, fn) {
    this.hooks[hook] = this.hooks[hook] || [];
    this.hooks[hook].push(fn);
};
MediaIns.prototype.unregisterHook = function (hook, fn) {
    if(!this.hooks[hook]) {
        return;
    }
...
MediaIns.prototype.attachPlugin = function (plugin) {
...
MediaIns.prototype.open = function(mediaUrl) {
...
MediaIns.prototype.getContainerElement = function() {
    return this._containerElem;
};

MediaIns.prototype.play = function(){
...
MediaIns.prototype.stop = function() {
    var me = this;
    exec(function() {
        me._position = -1;
        me._duration = -1;
...
MediaIns.prototype.seekTo = function(milliseconds) {
    var me = this;
    exec(function(p) {
        me._position = p;
...
MediaIns.prototype.pause = function() {
    exec(null, null, 'toast.Media', 'pause', [this.id]);
};

MediaIns.prototype.getDuration = function() {
    return this._duration;
};

MediaIns.prototype.getCurrentPosition = function() {
    return this._position;
};

MediaIns.prototype.setListener = function(listener) {
...
MediaIns.prototype.unsetListener = function() {
